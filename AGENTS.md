...
- **OpenRouter** (primary model routing)
  - Codex 3.7 Sonnet (chat-model-small)
  - Codex 3.7 Sonnet Thinking (chat-model-large, default)
  - Codex 3.5 Haiku (title generation)
- **Fireworks AI**

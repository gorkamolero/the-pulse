...
export const MAX_GUEST_PULSES = 16; // Internal limit (15 real pulses + 1 for auto-generated intro) — generous for launch
export const GUEST_PULSES_DISPLAY = 15; // What users see in the UI
